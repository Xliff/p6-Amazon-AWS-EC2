  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has SpotInstanceStateFault    $.fault                           is xml-element(:over-ride)    is xml-skip-null                                    is rw;
  ...
  has LaunchSpecification       $.launchSpecification             is xml-element(:over-ride)    is xml-skip-null                                    is rw;
  ...
  has SpotInstanceStatus        $.status                          is xml-element(:over-ride)    is xml-skip-null                                    is rw;
