  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has AssociatedTargetNetwork         @.associatedTargetNetwork    is xml-element    is xml-skip-null    is xml-container('associatedTargetNetwork')      is rw; 
  has ClientVpnAuthentication         @.authenticationOptions      is xml-element    is xml-skip-null    is xml-container('authenticationOptions')        is rw; 
  ...
  has ConnectionLogResponseOptions    $.connectionLogOptions       is xml-element    is xml-skip-null                                                     is rw; 
  ...
  has Str                             @.dnsServer                  is xml-element    is xml-skip-null    is xml-container('dnsServer')                    is rw; 
  ...
  has ClientVpnEndpointStatus         $.status                     is xml-element    is xml-skip-null                                                     is rw; 
