  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Int                              $.ipv6AddressCount                  is xml-element                                                   is rw;
  has InstanceIpv6Address              @.Ipv6Addresses                     is xml-element    is xml-container('Ipv6Addresses')              is rw;
  has InstanceIpv6Address              @.ipv6Addressess                    is xml-element    is xml-container('ipv6AddressesSet')           is rw;
  ...
  has PrivateIpAddressSpecification    @.privateIpAddressess               is xml-element    is xml-container('privateIpAddressesSet')      is rw;
  has Int                              $.SecondaryPrivateIpAddressCount    is xml-element                                                   is rw;
  has Int                              $.secondaryPrivateIpAddressCount    is xml-element                                                   is rw;
  has Str                              @.Groups                            is xml-element    is xml-container('Groups')                     is rw;
  has Str                              @.SecurityGroupId                   is xml-element    is xml-container('SecurityGroupId')            is rw;
