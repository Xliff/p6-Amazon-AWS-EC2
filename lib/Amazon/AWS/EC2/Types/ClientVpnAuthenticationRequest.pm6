  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has DirectoryServiceAuthenticationRequest    $.ActiveDirectory         is xml-element          is rw; 
  has CertificateAuthenticationRequest         $.MutualAuthentication    is xml-element          is rw; 
