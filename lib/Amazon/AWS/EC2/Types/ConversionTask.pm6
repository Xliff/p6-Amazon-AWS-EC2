  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has ImportInstanceTaskDetails    $.importInstance      is xml-element(:over-ride)    is xml-skip-null                                    is rw;
  has ImportVolumeTaskDetails      $.importVolume        is xml-element(:over-ride)    is xml-skip-null                                    is rw;
