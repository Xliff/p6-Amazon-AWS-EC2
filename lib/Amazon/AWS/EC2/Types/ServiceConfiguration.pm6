  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str                  @.networkLoadBalancerArns    is xml-element    is xml-container('networkLoadBalancerArnSet')      is rw; 
  ...
  has Str                  $.serviceState               is xml-element                                                       is rw;   #=  Pending | Available | Deleting | Deleted | Failed
