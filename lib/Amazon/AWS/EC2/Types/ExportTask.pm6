  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str                      $.exportTaskId      is xml-element          is rw; 
  has ExportToS3Task           $.exportToS3        is xml-element          is rw; 
  has InstanceExportDetails    $.instanceExport    is xml-element          is rw; 
