  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has BlockDeviceMapping                       @.blockDeviceMapping     is xml-element    is xml-skip-null    is xml-container('blockDeviceMapping')       is rw;
  has Bool                                     $.EbsOptimized           is xml-element    is xml-skip-null                                                 is rw;
  has Bool                                     $.ebsOptimized           is xml-element    is xml-skip-null                                                 is rw;
  has GroupIdentifier                          @.SecurityGroups         is xml-element    is xml-skip-null    is xml-container('SecurityGroups')           is rw;
  ...
  has Str                                      $.keyName                is xml-element    is xml-skip-null                                                 is rw;
  has SpotFleetMonitoring                      $.Monitoring             is xml-element    is xml-skip-null                                                 is rw;
  has SpotFleetMonitoring                      $.monitoring             is xml-element    is xml-skip-null                                                 is rw;
  ...
  has InstanceNetworkInterfaceSpecification    @.networkInterfaces      is xml-element    is xml-skip-null    is xml-container('networkInterfaceSet')      is rw;
  ...
  has Str                                      $.subnetId               is xml-element    is xml-skip-null                                                 is rw;
  has SpotFleetTagSpecification                @.TagSpecifications      is xml-element    is xml-skip-null    is xml-container('TagSpecifications')        is rw;
  has SpotFleetTagSpecification                @.tagSpecifications      is xml-element    is xml-skip-null    is xml-container('tagSpecificationSet')      is rw;
