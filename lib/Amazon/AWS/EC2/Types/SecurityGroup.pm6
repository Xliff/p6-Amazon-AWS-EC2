  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has IpPermission    @.ipPermissions          is xml-element('item', :over-ride)    is xml-skip-null    is xml-container('ipPermissions')            is rw; 
  has IpPermission    @.ipPermissionsEgress    is xml-element('item', :over-ride)    is xml-skip-null    is xml-container('ipPermissionsEgress')      is rw; 
  has Str             $.ownerId                is xml-element                        is xml-skip-null                                                 is rw; 
  has Tag             @.tags                   is xml-element('item', :over-ride)    is xml-skip-null    is xml-container('tagSet')                   is rw; 
