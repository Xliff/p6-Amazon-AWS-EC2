  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has DescribeFleetError             @.errors                              is xml-element    is xml-skip-null    is xml-container('errorSet')                   is rw; 
  ...
  has DescribeFleetsInstances        @.fleetInstances                      is xml-element    is xml-skip-null    is xml-container('fleetInstanceSet')           is rw; 
  ...
  has FleetLaunchTemplateConfig      @.launchTemplateConfigs               is xml-element    is xml-skip-null    is xml-container('launchTemplateConfigs')      is rw; 
  has OnDemandOptions                $.onDemandOptions                     is xml-element    is xml-skip-null                                                   is rw; 
  has Bool                           $.replaceUnhealthyInstances           is xml-element    is xml-skip-null                                                   is rw; 
  has SpotOptions                    $.spotOptions                         is xml-element    is xml-skip-null                                                   is rw; 
  has Tag                            @.tags                                is xml-element    is xml-skip-null    is xml-container('tagSet')                     is rw; 
  has TargetCapacitySpecification    $.targetCapacitySpecification         is xml-element    is xml-skip-null                                                   is rw; 
