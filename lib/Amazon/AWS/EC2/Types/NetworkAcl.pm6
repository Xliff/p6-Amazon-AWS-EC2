  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has NetworkAclAssociation    @.associations    is xml-element    is xml-container('associationSet')      is rw; 
  has Bool                     $.default         is xml-element                                            is rw; 
  has NetworkAclEntry          @.entrys          is xml-element    is xml-container('entrySet')            is rw; 
