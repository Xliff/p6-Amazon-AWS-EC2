  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has NetworkAclAssociation    @.associations                      is xml-skip-null    is xml-container('associationSet')      is rw;
  has Bool                     $.default         is xml-element    is xml-skip-null                                            is rw;
  has NetworkAclEntry          @.entrys                            is xml-skip-null    is xml-container('entrySet')            is rw;
