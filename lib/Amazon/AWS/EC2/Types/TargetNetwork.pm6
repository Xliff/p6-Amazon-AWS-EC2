  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str                  @.securityGroups         is xml-element('item')        is xml-skip-null    is xml-container('securityGroups')      is rw;
  has AssociationStatus    $.status                 is xml-element(:over-ride)    is xml-skip-null                                            is rw;
