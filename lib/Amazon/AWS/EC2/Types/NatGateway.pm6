  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has NatGatewayAddress       @.natGatewayAddresss      is xml-element    is xml-skip-null    is xml-container('natGatewayAddressSet')      is rw; 
  has Str                     $.natGatewayId            is xml-element    is xml-skip-null                                                  is rw; 
  has ProvisionedBandwidth    $.provisionedBandwidth    is xml-element    is xml-skip-null                                                  is rw; 
