  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has InstanceCount    @.instanceCounts                is xml-element    is xml-container('instanceCounts')      is rw; 
  has PriceSchedule    @.priceSchedules                is xml-element    is xml-container('priceSchedules')      is rw; 
  has Str              $.reservedInstancesId           is xml-element                                            is rw; 
  has Str              $.reservedInstancesListingId    is xml-element                                            is rw; 
  has Str              $.status                        is xml-element                                            is rw;   #=  active | pending | cancelled | closed
