  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has TransitGatewayAttachmentAssociation    $.association                   is xml-element(:over-ride)    is xml-skip-null                                    is rw;
  has Str                                    $.creationTime                  is xml-element                is xml-skip-null                                    is rw;
  has Str                                    $.resourceId                    is xml-element                is xml-skip-null                                    is rw;
  has Str                                    $.resourceOwnerId               is xml-element                is xml-skip-null                                    is rw;
  ...
  has Str                                    $.transitGatewayOwnerId         is xml-element                is xml-skip-null                                    is rw;
}
