  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Int                $.fromPort            is xml-element    is xml-skip-null                                              is rw; 
  has UserIdGroupPair    @.UserIdGroupPairs    is xml-element    is xml-skip-null    is xml-container('UserIdGroupPairs')      is rw; 
  ...
  has Str                $.ipProtocol          is xml-element    is xml-skip-null                                              is rw; 
  has IpRange            @.IpRanges            is xml-element    is xml-skip-null    is xml-container('IpRanges')              is rw; 
  has IpRange            @.ipRanges            is xml-element    is xml-skip-null    is xml-container('ipRanges')              is rw; 
  has Ipv6Range          @.Ipv6Ranges          is xml-element    is xml-skip-null    is xml-container('Ipv6Ranges')            is rw; 
  has Ipv6Range          @.ipv6Ranges          is xml-element    is xml-skip-null    is xml-container('ipv6Ranges')            is rw; 
  has PrefixListId       @.PrefixListIds       is xml-element    is xml-skip-null    is xml-container('PrefixListIds')         is rw; 
  has PrefixListId       @.prefixListIds       is xml-element    is xml-skip-null    is xml-container('prefixListIds')         is rw; 
