  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has AvailableCapacity    $.availableCapacity    is xml-element(:over-ride)    is xml-skip-null                                       is rw;
  has Str                  $.clientToken          is xml-element                is xml-skip-null                                       is rw;
  has Str                  $.hostId               is xml-element                is xml-skip-null                                       is rw;
  has HostProperties       $.hostProperties       is xml-element(:over-ride)    is xml-skip-null                                       is rw;
  ...
  has HostInstance         @.instances                                          is xml-skip-null    is xml-container('instances')      is rw;
