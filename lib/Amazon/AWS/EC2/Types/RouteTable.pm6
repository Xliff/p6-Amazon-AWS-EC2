  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has RouteTableAssociation    @.associations       is xml-element    is xml-skip-null    is xml-container('associationSet')         is rw; 
  has Str                      $.ownerId            is xml-element    is xml-skip-null                                               is rw; 
  has PropagatingVgw           @.propagatingVgws    is xml-element    is xml-skip-null    is xml-container('propagatingVgwSet')      is rw; 
  has Route                    @.routes             is xml-element    is xml-skip-null    is xml-container('routeSet')               is rw; 
