  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has NetworkInterfaceAttachment          $.attachment             is xml-element    is xml-skip-null                                                   is rw; 
  ...
  has NetworkInterfaceIpv6Address         @.ipv6Addressess         is xml-element    is xml-skip-null    is xml-container('ipv6AddressesSet')           is rw; 
  ...
  has NetworkInterfacePrivateIpAddress    @.privateIpAddressess    is xml-element    is xml-skip-null    is xml-container('privateIpAddressesSet')      is rw; 
