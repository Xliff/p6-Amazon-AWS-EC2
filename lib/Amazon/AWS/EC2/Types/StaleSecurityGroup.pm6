  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has StaleIpPermission    @.staleIpPermissions          is xml-element    is xml-skip-null    is xml-container('staleIpPermissions')            is rw; 
  has StaleIpPermission    @.staleIpPermissionsEgress    is xml-element    is xml-skip-null    is xml-container('staleIpPermissionsEgress')      is rw; 
