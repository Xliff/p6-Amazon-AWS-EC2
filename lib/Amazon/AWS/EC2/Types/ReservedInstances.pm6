  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str                $.end                    is xml-element    is xml-skip-null                                              is rw; 
  ...
  has Str                $.start                  is xml-element    is xml-skip-null                                              is rw; 
  has Str                $.state                  is xml-element    is xml-skip-null                                              is rw;   #=  payment-pending | active | payment-failed | retired
