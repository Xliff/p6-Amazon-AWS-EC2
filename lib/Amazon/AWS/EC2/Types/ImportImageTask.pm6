  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str               $.licenseType        is xml-element                is xml-skip-null                                               is rw;
  has Str               $.platform           is xml-element                is xml-skip-null                                               is rw;
  has Str               $.progress           is xml-element                is xml-skip-null                                               is rw;
  has SnapshotDetail    @.snapshotDetails    is xml-element(:over-ride)    is xml-skip-null    is xml-container('snapshotDetailSet')      is rw; 
