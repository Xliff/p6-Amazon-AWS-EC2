  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has LaunchTemplateBlockDeviceMappingRequest                       @.BlockDeviceMappings                  is xml-element    is xml-container('BlockDeviceMappings')               is rw; 
  has LaunchTemplateCapacityReservationSpecificationRequest         $.CapacityReservationSpecification     is xml-element                                                          is rw; 
  has LaunchTemplateCpuOptionsRequest                               $.CpuOptions                           is xml-element                                                          is rw; 
  has CreditSpecificationRequest                                    $.CreditSpecification                  is xml-element                                                          is rw; 
  has Bool                                                          $.DisableApiTermination                is xml-element                                                          is rw; 
  has Bool                                                          $.EbsOptimized                         is xml-element                                                          is rw; 
  has ElasticGpuSpecification                                       @.ElasticGpuSpecifications             is xml-element    is xml-container('ElasticGpuSpecifications')          is rw; 
  has LaunchTemplateElasticInferenceAccelerator                     @.ElasticInferenceAccelerators         is xml-element    is xml-container('ElasticInferenceAccelerators')      is rw; 
  has LaunchTemplateHibernationOptionsRequest                       $.HibernationOptions                   is xml-element                                                          is rw; 
  has LaunchTemplateIamInstanceProfileSpecificationRequest          $.IamInstanceProfile                   is xml-element                                                          is rw; 
  has Str                                                           $.ImageId                              is xml-element                                                          is rw; 
  has Str                                                           $.InstanceInitiatedShutdownBehavior    is xml-element                                                          is rw;   #=  stop | terminate
  has LaunchTemplateInstanceMarketOptionsRequest                    $.InstanceMarketOptions                is xml-element                                                          is rw; 
  ...
  has LaunchTemplateLicenseConfigurationRequest                     @.LicenseSpecifications                is xml-element    is xml-container('LicenseSpecifications')             is rw; 
  has LaunchTemplatesMonitoringRequest                              $.Monitoring                           is xml-element                                                          is rw; 
  has LaunchTemplateInstanceNetworkInterfaceSpecificationRequest    @.NetworkInterfaces                    is xml-element    is xml-container('NetworkInterfaces')                 is rw; 
  has LaunchTemplatePlacementRequest                                $.Placement                            is xml-element                                                          is rw; 
  has Str                                                           $.RamDiskId                            is xml-element                                                          is rw; 
  has Str                                                           @.SecurityGroups                       is xml-element    is xml-container('SecurityGroups')                    is rw; 
  has Str                                                           @.SecurityGroupIds                     is xml-element    is xml-container('SecurityGroupIds')                  is rw; 
  has LaunchTemplateTagSpecificationRequest                         @.TagSpecifications                    is xml-element    is xml-container('TagSpecifications')                 is rw; 
