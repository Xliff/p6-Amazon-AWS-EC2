  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has LaunchTemplateHibernationOptionsRequest                       $.HibernationOptions                   is xml-element(              :over-ride)          is xml-skip-null                                                          is rw;
  ...
  has LaunchTemplateLicenseConfigurationRequest                     @.LicenseSpecifications                is xml-element('item',       :over-ride)          is xml-skip-null    is xml-container('LicenseSpecificationSet')           is rw;
  has LaunchTemplatesMonitoringRequest                              $.Monitoring                           is xml-element('Monitoring', :over-ride)          is xml-skip-null                                                          is rw;
