  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has LaunchTemplateBlockDeviceMappingRequest                       @.BlockDeviceMappings                  is xml-element    is xml-skip-null    is xml-container('BlockDeviceMappings')               is rw; 
  has LaunchTemplateCapacityReservationSpecificationRequest         $.CapacityReservationSpecification     is xml-element    is xml-skip-null                                                          is rw; 
  has LaunchTemplateCpuOptionsRequest                               $.CpuOptions                           is xml-element    is xml-skip-null                                                          is rw; 
  ...
  has ElasticGpuSpecification                                       @.ElasticGpuSpecifications             is xml-element    is xml-skip-null    is xml-container('ElasticGpuSpecifications')          is rw; 
  has LaunchTemplateElasticInferenceAccelerator                     @.ElasticInferenceAccelerators         is xml-element    is xml-skip-null    is xml-container('ElasticInferenceAccelerators')      is rw; 
  has LaunchTemplateHibernationOptionsRequest                       $.HibernationOptions                   is xml-element    is xml-skip-null                                                          is rw; 
  has LaunchTemplateIamInstanceProfileSpecificationRequest          $.IamInstanceProfile                   is xml-element    is xml-skip-null                                                          is rw; 
  ...
  has LaunchTemplateInstanceMarketOptionsRequest                    $.InstanceMarketOptions                is xml-element    is xml-skip-null                                                          is rw; 
  ...
  has LaunchTemplateLicenseConfigurationRequest                     @.LicenseSpecifications                is xml-element    is xml-skip-null    is xml-container('LicenseSpecifications')             is rw; 
  has LaunchTemplatesMonitoringRequest                              $.Monitoring                           is xml-element    is xml-skip-null                                                          is rw; 
  has LaunchTemplateInstanceNetworkInterfaceSpecificationRequest    @.NetworkInterfaces                    is xml-element    is xml-skip-null    is xml-container('NetworkInterfaces')                 is rw; 
  has LaunchTemplatePlacementRequest                                $.Placement                            is xml-element    is xml-skip-null                                                          is rw; 
  ...
  has LaunchTemplateTagSpecificationRequest                         @.TagSpecifications                    is xml-element    is xml-skip-null    is xml-container('TagSpecifications')                 is rw; 
