  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str                   $.creationDate          is xml-element                                                is rw; 
  has Str                   $.description           is xml-element                                                is rw; 
  has Bool                  $.enaSupport            is xml-element                                                is rw; 
  has Str                   $.hypervisor            is xml-element                                                is rw;   #=  ovm | xen
  has Str                   $.imageId               is xml-element                                                is rw; 
  has Str                   $.imageLocation         is xml-element                                                is rw; 
  has Str                   $.imageOwnerAlias       is xml-element                                                is rw; 
  has Str                   $.imageOwnerId          is xml-element                                                is rw; 
  has Str                   $.imageState            is xml-element                                                is rw;   #=  pending | available | invalid | deregistered | transient | failed | error
  has Str                   $.imageType             is xml-element                                                is rw;   #=  machine | kernel | ramdisk
  has Bool                  $.isPublic              is xml-element                                                is rw; 
  has Str                   $.kernelId              is xml-element                                                is rw; 
  has Str                   $.name                  is xml-element                                                is rw; 
  has Str                   $.platform              is xml-element                                                is rw;   #=  Windows
  ...
  has Str                   $.rootDeviceType        is xml-element                                                is rw;   #=  ebs | instance-store
  has Str                   $.sriovNetSupport       is xml-element                                                is rw; 
  has StateReason           $.stateReason           is xml-element                                                is rw; 
  has Tag                   @.tags                  is xml-element    is xml-container('tagSet')                  is rw; 
  has Str                   $.virtualizationType    is xml-element                                                is rw;   #=  hvm | paravirtual
}