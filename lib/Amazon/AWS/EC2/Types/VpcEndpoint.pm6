  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has DnsEntry                   @.dnsEntrys                                        is xml-skip-null    is xml-container('dnsEntrySet')                is rw; 
  has SecurityGroupIdentifier    @.groups                                           is xml-skip-null    is xml-container('groupSet')                   is rw; 
  has Str                        @.networkInterfaceIds    is xml-element('item')    is xml-skip-null    is xml-container('networkInterfaceIdSet')      is rw; 
  ...
  has Str                        @.subnetIds              is xml-element('item')    is xml-skip-null    is xml-container('subnetIdSet')                is rw; 
