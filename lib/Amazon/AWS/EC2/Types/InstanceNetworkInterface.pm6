  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has InstanceNetworkInterfaceAttachment     $.attachment             is xml-element(        :over-ride)    is xml-skip-null                                                   is rw;
  ...
  has InstancePrivateIpAddress               @.privateIpAddressess    is xml-element('item', :over-ride)    is xml-skip-null    is xml-container('privateIpAddressesSet')      is rw;
