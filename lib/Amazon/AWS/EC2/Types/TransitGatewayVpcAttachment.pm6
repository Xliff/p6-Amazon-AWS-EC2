  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has TransitGatewayVpcAttachmentOptions    $.options                       is xml-element(:over-ride)    is xml-skip-null                                       is rw;
  ...
  has Str                                   @.subnetIds                     is xml-element('item')        is xml-skip-null    is xml-container('subnetIds')      is rw;
