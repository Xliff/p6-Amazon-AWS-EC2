  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has TransitGatewayVpcAttachmentOptions    $.options                       is xml-element                                       is rw; 
  ...
  has Str                                   @.subnetIds                     is xml-element    is xml-container('subnetIds')      is rw; 
  ...
  has Str                                   $.vpcOwnerId                    is xml-element                                       is rw; 
}