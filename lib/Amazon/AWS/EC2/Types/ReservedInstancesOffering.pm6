...
use Amazon::AWS::EC2::Types::PricingDetail;
use Amazon::AWS::EC2::Types::RecurringCharge;

class Amazon::AWS::EC2::Types::ReservedInstancesOffering is export
  does XML::Class[xml-element => 'item']
{
  ...
  has Num                $.fixedPrice                     is xml-element                                               is rw;
  ...
  has Bool               $.marketplace                    is xml-element                                               is rw;
  has Str                $.offeringClass                  is xml-element                                               is rw;   #=  standard | convertible
  has Str                $.offeringType                   is xml-element                                               is rw;   #=  Heavy Utilization | Medium Utilization | Light Utilization | No Upfront | Partial Upfront | All Upfront
  has PricingDetail      @.pricingDetailss                is xml-element    is xml-container('pricingDetailsSet')      is rw;
  has Str                $.productDescription             is xml-element                                               is rw;   #=  Linux/UNIX | Linux/UNIX (Amazon VPC) | Windows | Windows (Amazon VPC)
  has RecurringCharge    @.recurringCharges               is xml-element    is xml-container('recurringCharges')       is rw;
  has Str                $.reservedInstancesOfferingId    is xml-element                                               is rw;
  has Str                $.scope                          is xml-element                                               is rw;   #=  Availability Zone | Region
  has Num                $.usagePrice                     is xml-element                                               is rw;
}
