  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Num                $.fixedPrice                     is xml-element    is xml-skip-null                                               is rw; 
  ...
  has Bool               $.marketplace                    is xml-element    is xml-skip-null                                               is rw; 
  has Str                $.offeringClass                  is xml-element    is xml-skip-null                                               is rw;   #=  standard | convertible
  has Str                $.offeringType                   is xml-element    is xml-skip-null                                               is rw;   #=  Heavy Utilization | Medium Utilization | Light Utilization | No Upfront | Partial Upfront | All Upfront
  has PricingDetail      @.pricingDetailss                is xml-element    is xml-skip-null    is xml-container('pricingDetailsSet')      is rw; 
  ...
  has RecurringCharge    @.recurringCharges               is xml-element    is xml-skip-null    is xml-container('recurringCharges')       is rw; 
  has Str                $.reservedInstancesOfferingId    is xml-element    is xml-skip-null                                               is rw; 
  has Str                $.scope                          is xml-element    is xml-skip-null                                               is rw;   #=  Availability Zone | Region
  has Num                $.usagePrice                     is xml-element    is xml-skip-null                                               is rw; 
}