  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str          @.GroupIds                             is xml-element    is xml-container('GroupIds')        is rw; 
  has Str          @.GroupNames                           is xml-element    is xml-container('GroupNames')      is rw; 
  ...
  has Bool         $.Monitoring                           is xml-element                                        is rw; 
  ...
  has UserData     $.UserData                             is xml-element                                        is rw; 
}