  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Str          @.GroupIds                             is xml-element    is xml-skip-null    is xml-container('GroupIds')        is rw; 
  has Str          @.GroupNames                           is xml-element    is xml-skip-null    is xml-container('GroupNames')      is rw; 
  ...
  has UserData     $.UserData                             is xml-element    is xml-skip-null                                        is rw; 
}