  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Int                             $.instancePoolsToUseCount             is xml-element    is xml-skip-null                                                   is rw; 
  has SpotFleetLaunchSpecification    @.LaunchSpecifications                is xml-element    is xml-skip-null    is xml-container('LaunchSpecifications')       is rw; 
  has SpotFleetLaunchSpecification    @.launchSpecifications                is xml-element    is xml-skip-null    is xml-container('launchSpecifications')       is rw; 
  has LaunchTemplateConfig            @.LaunchTemplateConfigs               is xml-element    is xml-skip-null    is xml-container('LaunchTemplateConfigs')      is rw; 
  has LaunchTemplateConfig            @.launchTemplateConfigs               is xml-element    is xml-skip-null    is xml-container('launchTemplateConfigs')      is rw; 
  has LoadBalancersConfig             $.LoadBalancersConfig                 is xml-element    is xml-skip-null                                                   is rw; 
  has LoadBalancersConfig             $.loadBalancersConfig                 is xml-element    is xml-skip-null                                                   is rw; 
