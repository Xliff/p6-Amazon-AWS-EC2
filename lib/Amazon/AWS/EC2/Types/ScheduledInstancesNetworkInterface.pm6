  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has ScheduledInstancesIpv6Address               @.Ipv6Addresses                     is xml-element    is xml-container('Ipv6Addresses')                is rw; 
  ...
  has ScheduledInstancesPrivateIpAddressConfig    @.PrivateIpAddressConfigs           is xml-element    is xml-container('PrivateIpAddressConfigs')      is rw; 
