  ...
  does XML::Class[xml-element => 'item']
{
  ...
  has Bool              $.dataRetentionSupport    is xml-element                                          is rw; 
  ...
  has Str               $.ownerAlias              is xml-element                                          is rw; 
  has Str               $.ownerId                 is xml-element                                          is rw; 
  has PciId             $.pciId                   is xml-element                                          is rw; 
  has ProductCode       @.productCodes            is xml-element    is xml-container('productCodes')      is rw; 
  has Bool              $.public                  is xml-element                                          is rw; 
  has Str               $.shellVersion            is xml-element                                          is rw; 
  has FpgaImageState    $.state                   is xml-element                                          is rw; 
