...
class Amazon::AWS::EC2::Response::DescribeVolumeAttributeResponse is export
  does XML::Class[xml-element => 'DescribeVolumeAttributeResponse']
{
  also does Amazon::AWS::Roles::Response;

  has AttributeBooleanValue $.autoEnableIO is xml-element(        :over-ride)                                        is xml-skip-null is rw;
